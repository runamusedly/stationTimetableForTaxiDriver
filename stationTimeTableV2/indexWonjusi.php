...
<body>
  <h1 style="text-align:center; font-size:40px;">원주시 열차 시간표</h1>
    ...
    <input type="button" class="indexTourButton" onclick="document.location='tour.php?id=wonjuStation&file=tourWonju'" value="관광열차(장날,주말)">
		...
		?>
		<p id="notice"></p>
	<div style="background-color: gray; width: 90%; margin: auto;">
	<p>안내문</p>
	<ul>
		...
		<li>문의 및 건의 사항이 있을 경우에는 아래의 카카오톡 채팅방(제목:원주열차시간표)이나 이메일주소를 통해 메시지를 남겨주세요.</li>
	</ul>
	</div>
	...
	<address>
	<a href="https://open.kakao.com/o/guO9O4Pg">카카오톡 채팅방(원주열차시간표)</a><br>
	이메일: runamusedly@outlook.com<br>
	</address>
	<?php
  date_default_timezone_set("Asia/Seoul");
  $now = date("Y-m-d_H");
